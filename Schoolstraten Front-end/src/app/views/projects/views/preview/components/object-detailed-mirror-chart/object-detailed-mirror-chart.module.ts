...
import { ObjectDetailedMirrorChartComponent } from "./object-detailed-mirror-chart.component";
...
@NgModule({
  ...
  declarations: [ObjectDetailedMirrorChartComponent],
  exports: [ObjectDetailedMirrorChartComponent],
})
export class ObjectDetailedMirrorChartModule {}
