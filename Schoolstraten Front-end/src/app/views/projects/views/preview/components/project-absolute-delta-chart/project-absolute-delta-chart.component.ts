...
@Component({
  selector: "project-absolute-delta-chart",
  templateUrl: "./project-absolute-delta-chart.component.html",
  styleUrls: ["./project-absolute-delta-chart.component.scss"],
})
export class ProjectAbsoluteDeltaChartComponent implements OnInit, OnDestroy {
  @ViewChild("deltaAbsoluteChart") deltaAbsoluteChart: HTMLElement;
    ...
    tooltips: {
      ...
      callbacks: {
        ...
        label: (item, data) => {
          ...
          let value: number = +data.datasets[item.datasetIndex].data[
            item.index
          ];
          return value % 1 !== 0
